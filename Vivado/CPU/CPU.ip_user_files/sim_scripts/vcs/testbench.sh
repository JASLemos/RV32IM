...
#
# Script generated by Vivado on Tue Feb 25 14:48:37 -0300 2025
...
#
# Usage        : testbench.sh
#                testbench.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                testbench.sh [-reset_run]
#                testbench.sh [-reset_log]
#                testbench.sh [-help]
#
...
#                script (type 'testbench.sh -help' for more information).
#
...
design_libs=(xpm blk_mem_gen_v8_4_8 xil_defaultlib dist_mem_gen_v8_0_15)

# simulation root library directory
sim_lib_dir="vcs_lib"

# script info
echo -e "testbench.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./testbench.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  "../../../../../../Mark/ VI/src/ALU.v" \
  "../../../../../../Mark/ VI/src/Adder.v" \
  "../../../../../../Mark/ VI/src/BranchUnit.v" \
  "../../../../../../Mark/ VI/src/CPU.v" \
  "../../../../../../Mark/ VI/src/Control.v" \
  "../../../../../../Mark/ VI/src/Divisor.v" \
  "../../../../../../Mark/ VI/src/EXU.v" \
  "../../../../../../Mark/ VI/src/Extend.v" \
  "../../../../../../Mark/ VI/src/HazardControl.v" \
  "../../../../../../Mark/ VI/src/IDU.v" \
  "../../../../../../Mark/ VI/src/IFU.v" \
  "../../../../../../Mark/ VI/src/LoadDecoder.v" \
  "../../../../../../Mark/ VI/src/MAU.v" \
  "../../../../../../Mark/ VI/src/Mux.v" \
  "../../../../../../Mark/ VI/src/Mux4x1.v" \
  "../../../../../../Mark/ VI/src/Register.v" \
  "../../../../../../Mark/ VI/src/RegisterFile.v" \
  "../../../../../../Mark/ VI/src/StoreDecoder.v" \
  "../../../../../../Mark/ VI/src/WBU.v" \
  "../../../../../../Mark/ VI/src/wallace/Wall.v" \
  "../../../../../../Mark/ VI/src/wallace/Wallace_Tree.v" \
  "../../../../../../Mark/ VI/src/wallace/adder.v" \
  "../../../../../../Mark/ VI/tests/testbench.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
reset_run()
{
  files_to_remove=(ucli.key testbench_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc testbench_simv.daidir vcs_lib c.obj)
...
Usage: testbench.sh [-step]\n\
Usage: testbench.sh [-lib_map_path]\n\
Usage: testbench.sh [-reset_run]\n\
Usage: testbench.sh [-reset_log]\n\
Usage: testbench.sh [-keep_index]\n\
