...
#
# Script generated by Vivado on Wed Apr 02 19:01:30 -0300 2025
...
# script info
echo -e "testbench.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L blk_mem_gen_v8_4_9 -L dist_mem_gen_v8_0_15 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot testbench xil_defaultlib.testbench xil_defaultlib.glbl -log elaborate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm blk_mem_gen_v8_4_9 dist_mem_gen_v8_0_15)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb testbench.wdb xsim.dir libdpi.so)
