...
design_libs_elab="-libname xpm -libname blk_mem_gen_v8_4_8 -libname xil_defaultlib -libname dist_mem_gen_v8_0_15 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm blk_mem_gen_v8_4_8 xil_defaultlib dist_mem_gen_v8_0_15)
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.testbench xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.testbench -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log testbench_sc.so .tmp_log xcelium_lib waves.shm c.obj)
